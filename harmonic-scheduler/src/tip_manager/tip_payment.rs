// Ported from jito-solana (core/src/tip_manager/tip_payment.rs)
// Only change: AccountSharedData replaced with raw &[u8] + &Pubkey owner.
...
impl JitoTipPaymentConfig {
    ...
    pub(crate) fn from_account_data(
        ...
        JitoTipPaymentConfig::try_from_slice(&data[8..]).map_err(|e| {
