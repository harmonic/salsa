// Ported from https://github.com/jito-foundation/jito-solana (core/src/tip_manager/tip_distribution.rs)
// Adapted: AccountSharedData replaced with raw bytes + owner for external scheduler use.
...
impl JitoTipDistributionConfig {
    ...
    // Changed from original: takes raw bytes + owner instead of AccountSharedData
    pub(crate) fn from_account_data(
        ...
        JitoTipDistributionConfig::try_from_slice(&data[8..83]).map_err(|e| {
